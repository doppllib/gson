...
@interface ComGoogleGsonMixedStreamTest ()

- (void)assertJsonEqualsWithNSString:(NSString *)a
...
__attribute__((unused)) static void ComGoogleGsonMixedStreamTest_assertJsonEqualsWithNSString_withNSString_(ComGoogleGsonMixedStreamTest *self, NSString *a, NSString *b);
...
- (void)testWriteMixedStreamed {
  ...
  [jsonWriter endArray];
  ComGoogleGsonMixedStreamTest_assertJsonEqualsWithNSString_withNSString_(self, ComGoogleGsonMixedStreamTest_CARS_JSON, [stringWriter description]);
}

- (void)assertJsonEqualsWithNSString:(NSString *)a
                        withNSString:(NSString *)b {
  ComGoogleGsonMixedStreamTest_assertJsonEqualsWithNSString_withNSString_(self, a, b);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[2].selector = @selector(assertJsonEqualsWithNSString:withNSString:);
  methods[3].selector = @selector(testReadMixedStreamed);
  methods[4].selector = @selector(testReaderDoesNotMutateState);
  methods[5].selector = @selector(testWriteDoesNotMutateState);
  methods[6].selector = @selector(testReadInvalidState);
  methods[7].selector = @selector(testReadClosed);
  methods[8].selector = @selector(testWriteInvalidState);
  methods[9].selector = @selector(testWriteClosed);
  methods[10].selector = @selector(testWriteNulls);
  methods[11].selector = @selector(testReadNulls);
  methods[12].selector = @selector(testWriteHtmlSafe);
  methods[13].selector = @selector(testWriteLenient);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "BLUE_MUSTANG", "LComGoogleGsonMixedStreamTest_Car;", .constantValue.asLong = 0, 0x1a, -1, 3, -1, -1 },
    { "BLACK_BMW", "LComGoogleGsonMixedStreamTest_Car;", .constantValue.asLong = 0, 0x1a, -1, 4, -1, -1 },
    { "RED_MIATA", "LComGoogleGsonMixedStreamTest_Car;", .constantValue.asLong = 0, 0x1a, -1, 5, -1, -1 },
    { "CARS_JSON", "LNSString;", .constantValue.asLong = 0, 0x1a, -1, 6, -1, -1 },
  };
  static const void *ptrTable[] = { "LJavaIoIOException;", "assertJsonEquals", "LNSString;LNSString;", &ComGoogleGsonMixedStreamTest_BLUE_MUSTANG, &ComGoogleGsonMixedStreamTest_BLACK_BMW, &ComGoogleGsonMixedStreamTest_RED_MIATA, &ComGoogleGsonMixedStreamTest_CARS_JSON, "LComGoogleGsonMixedStreamTest_Car;" };
  static const J2ObjcClassInfo _ComGoogleGsonMixedStreamTest = { "MixedStreamTest", "com.google.gson", ptrTable, methods, fields, 7, 0x11, 14, 4, -1, 7, -1, -1, -1 };
...
void ComGoogleGsonMixedStreamTest_assertJsonEqualsWithNSString_withNSString_(ComGoogleGsonMixedStreamTest *self, NSString *a, NSString *b) {
