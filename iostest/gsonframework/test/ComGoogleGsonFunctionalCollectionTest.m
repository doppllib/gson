...
- (void)testWildcardCollectionField {
  ...
  NSString *json = [((ComGoogleGsonGson *) nil_chk(gson_)) toJsonWithId:target];
  NSString *expectedJsonA = [objA getExpectedJson];
  JunitFrameworkTestCase_assertTrueWithBoolean_([((NSString *) nil_chk(json)) java_contains:expectedJsonA]);
  NSString *expectedJsonB = [objB getExpectedJson];
  JunitFrameworkTestCase_assertTrueWithBoolean_([json java_contains:expectedJsonB]);
