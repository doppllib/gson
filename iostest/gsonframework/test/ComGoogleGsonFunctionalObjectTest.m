...
- (void)testSingletonLists {
  ...
  ComGoogleGsonDopplJsonCompare_jsonSameAssertWithNSString_withNSString_(@"{\"attributes\":[],\"departments\":[]}", [gson toJsonWithId:product]);
  ...
  ComGoogleGsonDopplJsonCompare_jsonSameAssertWithNSString_withNSString_(@"{\"attributes\":[],\"departments\":[{\"name\":\"abc\",\"code\":\"123\"}]}", [gson toJsonWithId:product]);
  [gson fromJsonWithNSString:[gson toJsonWithId:product] withIOSClass:ComGoogleGsonFunctionalObjectTest_Product_class_()];
  [((id<JavaUtilList>) nil_chk(product->attributes_)) addWithId:@"456"];
  ComGoogleGsonDopplJsonCompare_jsonSameAssertWithNSString_withNSString_(@"{\"attributes\":[\"456\"],\"departments\":[{\"name\":\"abc\",\"code\":\"123\"}]}", [gson toJsonWithId:product]);
  [gson fromJsonWithNSString:[gson toJsonWithId:product] withIOSClass:ComGoogleGsonFunctionalObjectTest_Product_class_()];
}
